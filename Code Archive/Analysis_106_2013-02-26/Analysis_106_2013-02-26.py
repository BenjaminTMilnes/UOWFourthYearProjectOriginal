...
class Analysis:
	...
	def Analyse(This, DesiredEventNumber = 999999999):
		...
		for i in range(EventNumber):
			...
			try:
				...
				if (This.IsValidSpill()):#Can this be placed earlier? As far as I can see, it needs to be after module.GetEntry
	...
	def InitialiseHistograms(This):
		...
		This.HistogramCollection1.NewHistogram1D("Recon_Proton_Multiplicity", "Proton/Reconstruction/Multiplicity/", "Proton Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Recon_Proton_Multiplicity_Stacked", "Proton/Reconstruction/Multiplicity/", "Proton Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
		...
		This.HistogramCollection1.NewHistogram1D("Recon_ECal_Multiplicity", "Photons/Reconstruction/Multiplicity/", "ECal Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Recon_ECal_Multiplicity_Stacked", "Photons/Reconstruction/Multiplicity/", "ECal Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
		...
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedX_Process", "Photons/ElectronsAndAntielectrons/", "Separation in X axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"].X * 10, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedY_Process", "Photons/ElectronsAndAntielectrons/", "Separation in Y axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"].Y * 10, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedZ_Process", "Photons/ElectronsAndAntielectrons/", "Separation in Z axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"].Z * 10, "Number")
		...
		This.HistogramCollection1.NewHistogram1D("ElectronsAndAntielectrons_InvariantMass", "Photons/ElectronsAndAntielectrons/Invariant Mass/", "Invariant Mass Distribution of Electron-Positron Pairs", "Mass (MeV)", 100, 0, 100, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_InvariantMass_Stacked", "Photons/ElectronsAndAntielectrons/Invariant Mass/", "Invariant Mass Distribution of Electron-Positron Pairs", "Mass (MeV)", 100, 0, 100, "Number")
		...
		This.HistogramCollection1.NewHistogram1D("ProtonTrackMultiplicityECal", "Proton/Reconstruction/Multiplicity/", "Proton track multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		This.HistogramCollection1.NewHistogram1D("ECalMultiplicityECal", "Photons/Reconstruction/Multiplicity/", "ECal multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		...
		This.HistogramCollection1.NewHistogram1D("Recon_Track_Multiplicity", "PIDs/Reconstruction/Multiplicity/", "PID Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Recon_Track_Multiplicity_Stacked", "PIDs/Reconstruction/Multiplicity/", "PID Track Multiplicity", "Multiplicity", 5, 0, 5, "Number")
	...
	def runEvent(This):
		...
		if (TPCValidPIDNumber <= This.Parameters["PIDTrackMultiplicityLimit"] and DeltaPGammaCriteria[7]):
			DeltaPGammaCriteria[8] = True
			
		if (NTrackerECalRecon <= This.Parameters["ECalMultiplicityLimit"] and DeltaPGammaCriteria[8]):
			DeltaPGammaCriteria[9] = True
			
		if (NumberOfReconstructedMuLeptonTracks <= This.Parameters["MuonMultiplicityCut"] and DeltaPGammaCriteria[9]):
			DeltaPGammaCriteria[10] = True
		
		if (NumberOfReconstructedElectronTracks <= This.Parameters["ElectronMultiplicityCut"] and DeltaPGammaCriteria[10]):
			DeltaPGammaCriteria[11] = True	
		
		if (NumberOfReconstructedAntiElectronTracks <= This.Parameters["PositronMultiplicityCut"] and DeltaPGammaCriteria[11]):
		...
		if (TPCValidPIDNumber <= This.Parameters["PIDTrackMultiplicityLimit"] and ProtonPhotonToElectrons[7]):
			ProtonPhotonToElectrons[8] = True
			
		if (NTrackerECalRecon <= This.Parameters["ECalMultiplicityLimit"] and ProtonPhotonToElectrons[8]):
			ProtonPhotonToElectrons[9] = True
			
		if (NumberOfReconstructedMuLeptonTracks <= This.Parameters["MuonMultiplicityCut"] and ProtonPhotonToElectrons[9]):
				...
				if (len(ArgumentComponents) == 2):
					...
					if (ArgumentComponents[0] == "P"):
						if (ArgumentComponents[1] == str(0)):
							...
							SimulationInformation["InputFilePurity"] = ("Reading events from:" + str(DefaultInputFileLocatorPurified), "P2")
