...
class Analysis:
	...
	def InitialiseHistograms(This):
		...
		"""
		This.HistogramCollection1.NewStackedHistogram1D("TrackMultiplicity", "PIDs/", "Track Multiplicity for Different Interactions", "Number of Tracks", 10, 0, 10, "Number of Events", ["QS", "ES", "C", "DIS", "RP", "O"])
		This.HistogramCollection1.NewStackedHistogram1D("TorrentMultiplicity", "EC Clusters/", "Torrent Multiplicity for Different Interactions", "Number of Torrents", 10, 0, 10, "Number of Events", ["QS", "ES", "C", "DIS", "RP", "O"])
