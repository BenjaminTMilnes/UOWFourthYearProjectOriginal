...
class Analysis:
	...
	"""def isGoodSpill(This):
		...
		if (This.MonteCarloData == True):
			...
			if (This.data_quality.ND280OffFlag == 0 and This.beam_summary.BeamSummaryDataStatus == 1):
				GoodSpill = True
				
				for beam_data in This.beam_summary.BeamSummaryData:
					
					if (beam_data.GoodSpillFlag != 1):
				...
				if (len(ArgumentComponents) == 2):
					...
					if (ArgumentComponents[0] == "P"):
						if (ArgumentComponents[1] == str(0)):
							...
							InputFileLocatorList3 = InputFileLocatorList1 + InputFileLocatorList2
							
							InputFileLocatorList = glob.glob(DefaultInputFileLocatorPurified + "*.root")#Until code is ready
