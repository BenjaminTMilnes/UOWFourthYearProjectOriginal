...
#### COMMAND LINE
####
#### This class takes command line arguments, which are separated by spaces, and deconstructs them to 
#### link a command to an option or quantity. This way the command line arguments can be ordered in any way
#### and omitted randomly, and the program won't crash.
#### 
#### Modified 2013.01.27 09:15, Completed
#### 
########################################################################################################################
