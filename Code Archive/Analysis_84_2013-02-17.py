...
class Analysis:
	...
	def InitialiseHistograms(This):
		...
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedX", "Photons/ElectronsAndAntielectrons/", "Separation in X axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedY", "Photons/ElectronsAndAntielectrons/", "Separation in Y axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_Separation_StackedZ", "Photons/ElectronsAndAntielectrons/", "Separation in Z axis between electrons and antielectrons", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
	...
	def EventContainsElectronPositron(This, PIDParticles1, Protons, TruthInteractionType):
		...
		for Electron1 in Electrons:
			for Positron1 in Positrons:
				...
				if (Electron1.TrueVertex.TruthVertexID == Positron1.TrueVertex.TruthVertexID):
					PairProduced = True
