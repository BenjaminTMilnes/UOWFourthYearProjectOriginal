...
class Analysis:
	...
	def Analyse(This, DesiredEventNumber = 999999999):
		...
		for i in range(EventNumber):
			...
			This.TruthStatistics.Statistics["NPEvents"].Quantity = i
	...
	def runEvent(This):
		...
		if (len(TrackerTrueInteractions) == 1):
			
			TrueEventInteraction = TrackerTrueInteractions[0]
			
		elif (len(TrackerTrueInteractions) > 1):
			
			if ("DeltaPGamma" in TrackerTrueInteractions):
			
				TrueEventInteraction = "DeltaPGamma"
				
			elif ("DeltaPPi" in TrackerTrueInteractions):
		...
		elif (len(TrackerTrueInteractions) == 0):
