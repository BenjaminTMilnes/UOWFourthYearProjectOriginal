...
class Analysis:
	...
	def runEvent(This):
		...
		DeltaPGammaCriteria = [True, False, False, False, False, False, False, False, False]
		...
		if ((NTrackerECalRecon > 0) and DeltaPGammaCriteria[3]):
		...
		if (NumberOfReconstructedProtonTracks <= 3 and DeltaPGammaCriteria[6]):
			DeltaPGammaCriteria[7] = True
			
		if (NTrackerECalRecon <= 3 and DeltaPGammaCriteria[7]):
		...
		ProtonPhotonToElectrons = [True, False, False, False, False, False, False, False, False]
		...
		if (EventContainsElectronPositronPair and ProtonPhotonToElectrons[3]):
			ProtonPhotonToElectrons[4] = True
			
		if (ElectronPositronPairPointsWithinAngle >= 1 and ProtonPhotonToElectrons[4]):
		...
		if (NumberOfReconstructedProtonTracks <= 3 and ProtonPhotonToElectrons[6]):
			ProtonPhotonToElectrons[7] = True
			
		if (NTrackerECalRecon <= 4 and ProtonPhotonToElectrons[7]):
