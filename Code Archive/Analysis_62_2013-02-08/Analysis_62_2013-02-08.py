...
class Analysis:
	...
	def __init__(This, InputFileLocatorList, OutputROOTFileLocator, SimulationInformationFileLocator, SimulationInformation):
		...
		This.Parameters["AngularLocalityLimit"] = 20 # In degrees
		...
		for i in range(EventNumber):
			...
			if (This.InputTimeTest == False):
				...
				if ((OutputData or (i == EventNumber - 1)) and (SuitableEvents > 0)):
					...
					This.EfficiencyStatistics_Delta1ToProtonPhoton.Statistics["NEvents11EventsRemaining"].Title = "Selection 11 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Events Remaining"
					...
					This.EfficiencyStatistics_Delta1ToProtonPhoton.Statistics["NEvents11Delta"].Title = "Selection 11 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Delta -> p gamma Events Remaining"
					...
					This.EfficiencyStatistics_Delta1ToProtonPhoton.Statistics["NEvents12EventsRemaining"].Title = "Selection 12 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Events Remaining"
					...
					This.EfficiencyStatistics_Delta1ToProtonPhoton.Statistics["NEvents12Delta"].Title = "Selection 12 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Delta -> p gamma Events Remaining"
					...
					This.EfficiencyStatistics_Delta1ToProtonPhotonPP.Statistics["NEvents9EventsRemaining"].Title = "Selection 9 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Events Remaining"
					...
					This.EfficiencyStatistics_Delta1ToProtonPhotonPP.Statistics["NEvents9Delta"].Title = "Selection 9 - The smallest angle was less than " + str(This.Parameters["AngularLocalityLimit"]) + " degees - Delta -> p gamma Events Remaining"
	...
	def runEvent(This):
			...
			for Photon1 in ReconstructedPhotons1:
				...
				for Photon2 in ReconstructedPhotons1:#For finding invariant mass of pi0
					...
					if (Photon2 != Photon1):#Is this valid in python?
						...
						if ((Angle1 < This.Parameters["AngularLocalityLimit"]) and (Angle2 < This.Parameters["AngularLocalityLimit"])):
		...
		if (SmallestAngle <= This.Parameters["AngularLocalityLimit"] and DeltaPGammaCriteria[11]):
			...
			for Positron1 in Positrons:
				...
				if (Geometry.WithinLocality(Electron1.FrontPosition, Positron1.FrontPosition, This.Parameters["LocalityLimit"])):
					...
					for Proton1 in Protons:
						...
						if (Angle1 < This.Parameters["AngularLocalityLimit"]):
...
def main():
	...
	sys.stdout = DataWriter.DataWriter(SimulationInformationFileLocator, "a")
