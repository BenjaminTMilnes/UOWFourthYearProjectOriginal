...
class Analysis:
	...
	def Analyse(self, n = 999999999):
		...
		for CriteriaListCounter in xrange(len(self.SelectionCriteriaList)):
		...
		for CriteriaListCounter in xrange(len(self.SelectionCriteriaList)):
			print self.SelectionCriteriaList[CriteriaListCounter].AbsoluteEfficiency , self.SelectionCriteriaList[CriteriaListCounter].RelativeEfficiency , self.SelectionCriteriaList[CriteriaListCounter].Purity
