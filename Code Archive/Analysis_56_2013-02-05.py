...
class Analysis:
	...
	def __init__(This, InputFileLocatorList, OutputROOTFileLocator, OutputTextFileLocator, SimulationInformation):
...
def main():
	...
	OutputTextFileLocator = FileAdministrator.CreateFilePath(DataLocation, ".txt", SimulationInformation)
	
	sys.stdout = DataWriter.DataWriter(OutputTextFileLocator)
	...
	Analysis1 = Analysis(InputFileLocatorList, OutputROOTFileLocator, OutputTextFileLocator, SimulationInformation)
