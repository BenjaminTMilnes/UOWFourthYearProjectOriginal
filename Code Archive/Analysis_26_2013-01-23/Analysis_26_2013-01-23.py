...
class Analysis:
	...
	def Analyse(self, DesiredEventNumber = 999999999):
		...
		if (self.InputTimeTest == False):
			...
			self.ROOTFile1.NewHistogram1D("PionPurity", "Purity for the Selections", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Pion/")
			...
			self.ROOTFile1.HistogramDictionary["PionPurity"].Histogram.SetMarkerStyle(3)
			self.ROOTFile1.HistogramDictionary["PionPurity"].Histogram.SetOption("LP")
			self.ROOTFile1.HistogramDictionary["PionPurity"].Histogram.SetStats(0)
		...
		if (Criteria[len(Criteria) - 1] == True):
			...
			if (DeltaPGammaEvent):
				...
				try:	
					...
					self.FinalInvariantMass.NewHistogram1D("Final_Invariant_Mass_ES", "Invariant Mass contribution from true QES interactions", "Mass (GeV)", "Number", 100, 0, 3000, "QES", "Cuts/Invariant Mass/Constituent Histograms/")
					self.FinalInvariantMass.HistogramDictionary["Final_Invariant_Mass_ES"].Histogram.Fill(DeltaBaryon.InvariantModulus())
			...
			for Photon1 in PhotonList:
				...
				if (DeltaPGammaEvent):
					...
					try:	
						...
						self.InvariantMassAllECal.NewHistogram1D("Invariant_Mass_ES", "Invariant Mass contribution from true QES interactions", "Mass (GeV)", "Number", 100, 0, 3000, "QES", "Cuts/Invariant Mass/All ECal/Constituent Histograms/")
						self.InvariantMassAllECal.HistogramDictionary["Invariant_Mass_ES"].Histogram.Fill(DeltaBaryon.InvariantModulus())
