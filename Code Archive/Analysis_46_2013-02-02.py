...
class Analysis:
	...
	def runEvent(This):
		...
		if (NumberOfReconstructedProtonTracks == 1):
			...
			This.StackedHistograms["SingleProtonPIDMultiplicity"].ConstituentFill1D(ProcessSeparator.ProcessDictionary, EventProcess, len(ReconstructedObjects1), "PID Multiplicity for single proton track events", "Multiplicity", "Number", 10, 0, 10, "ProtonMultiplicity")
			This.StackedHistograms["SingleProtonECalMultiplicity"].ConstituentFill1D(ProcessSeparator.ProcessDictionary, EventProcess, len(ReconstructedPhotons1), "ECal Multiplicity for single proton track events", "Multiplicity", "Number", 10, 0, 10, "ECalMultiplicity")
