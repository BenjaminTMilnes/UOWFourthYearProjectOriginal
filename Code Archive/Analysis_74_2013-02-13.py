...
class Analysis:
	...
	def InitialiseStatistics(This):
		...
		This.ReconstructedStatistics.NewStatistic("IdentifiedTPCsFromP0D", "Number of Identified PIDs that originate from the P0D")
		
		for Subdetector, SubdetectorCode in SubdetectorCodes.Subdetectors.iteritems():
			
			StatisticKey = "IdentifiedPIDsin" + Subdetector
			StatisticTitle = "Number of Identified PIDs that originate from the " + Subdetector
			
			This.ReconstructedStatistics.NewStatistic(StatisticKey, StatisticTitle)
	...
	def InitialiseHistograms(This):
		...
		# DON'T CHANGE ANY OF THIS. DON'T REVERT TO OLDER CODE; IT TOOK AGES TO DO.
		...
		This.HistogramCollection1.NewHistogram1D("PhotonAngles", "Photon/Recon/All/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position", "Angle", 100, 0, 180, "Number")
		This.HistogramCollection1.NewHistogram1D("ProtonPhotonTimeSeparations", "Photon/Recon/", "Time Separation between the Reconstructed Proton Track and Photon EC Cluster", "Time Separation", 100, 0, 4000, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Photon_Angles_Stacked", "Photon/Recon/All/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position", "Angle", 100, 0, 180, "Number")
		
		This.HistogramCollection1.NewHistogram1D("SelectedPhotonAngles", "Photon/Recon/Selected/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Selected_Photon_Angles_Stacked", "Photon/Recon/Selected/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		
		This.HistogramCollection1.NewStackedHistogram1D("Photon_Angles_Stacked_Track", "Photon/Recon/Track/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Photon_Angles_Stacked_Shower", "Photon/Recon/Shower/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Selected_Photon_Angles_Stacked_Track", "Photon/Recon/Selected/Track/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		This.HistogramCollection1.NewStackedHistogram1D("Selected_Photon_Angles_Stacked_Shower", "Photon/Recon/Selected/Shower/", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position for the single proton and the single selected photon", "Angle", 100, 0, 180, "Number")
		...
		This.HistogramCollection1.NewHistogram1D("MultipleProtonPIDMultiplicityECal", "Proton/Recon/Multiplicity/", "PID multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		This.HistogramCollection1.NewHistogram1D("MultipleProtonECalMultiplicityECal", "Photon/Recon/Multiplicity/", "ECal multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		
		This.HistogramCollection1.NewHistogram1D("MultipleProtonPIDMultiplicityPP", "Proton/Recon/Multiplicity/", "PID multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		This.HistogramCollection1.NewHistogram1D("MultipleProtonECalMultiplicityPP", "Photon/Recon/Multiplicity/", "ECal multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", 10, 0, 10, "Number")
		
		This.HistogramCollection1.NewHistogram1D("ElectronPositronSeparationX", "Photon/", "Electron positron separation in X axis", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
		This.HistogramCollection1.NewHistogram1D("ElectronPositronSeparationY", "Photon/", "Electron positron separation in Y axis", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
		This.HistogramCollection1.NewHistogram1D("ElectronPositronSeparationZ", "Photon/", "Electron positron separation in Z axis", "Separation (mm)", 100, 0, This.Parameters["LocalityLimit"] * 10, "Number")
	...
	def runEvent(This):
		...
		for PID in This.Reconstructed_Global.PIDs: # Loop over the PIDs if they exist
			...
			if (SuitableTPCNodeNumber):
				...
				print This.BasicInformation.SubrunID, This.BasicInformation.EventID, PID.Detectors
		...
		for ReconstructedObject1 in ReconstructedObjects1:
			...
			#print ReconstructedObject1.Detectors[0], This.FGD1Fiducial.Contains(ReconstructedObject1.FrontPosition.X, ReconstructedObject1.FrontPosition.Y, ReconstructedObject1.FrontPosition.Z), This.FGD2Fiducial.Contains(ReconstructedObject1.FrontPosition.X, ReconstructedObject1.FrontPosition.Y, ReconstructedObject1.FrontPosition.Z)

			for Subdetector, SubdetectorCode in SubdetectorCodes.Subdetectors.iteritems():
				
				if (ReconstructedObject1.Detectors[0] == SubdetectorCode):
					
					StatisticKey = "IdentifiedPIDsin" + Subdetector
					
					This.ReconstructedStatistics.Statistics[StatisticKey].Quantity += 1
					
					if (Subdetector == SubdetectorCodes.Subdetectors["P0D"]):
						P0DActivity = True
		...
		"""if (NumberOfReconstructedProtonTracks == 1):
			...
			This.HistogramCollection1.Histograms["SelectedPhotonAngles"].Histogram.Fill(SmallestAngle)
		...
		if ((not P0DActivity) and DeltaPGammaCriteria[3]):
		...
		if (NumberOfReconstructedProtonTracks <= 3 and DeltaPGammaCriteria[7]):
			DeltaPGammaCriteria[8] = True
			
		if (NTrackerECalRecon <= 3 and DeltaPGammaCriteria[8]):
		...
		if (NumberOfReconstructedProtonTracks <= 3 and ProtonPhotonToElectrons[7]):
			ProtonPhotonToElectrons[8] = True
			
		if (NTrackerECalRecon <= 4 and ProtonPhotonToElectrons[8]):
		...
		if (DeltaPGammaCriteria[6]):
			...
			This.HistogramCollection1.Histograms["MultipleProtonPIDMultiplicityECal"].Populate(NumberOfReconstructedProtonTracks)
			This.HistogramCollection1.Histograms["MultipleProtonECalMultiplicityECal"].Populate(NTrackerECalRecon)
			
		if (ProtonPhotonToElectrons[6]):
			This.HistogramCollection1.Histograms["MultipleProtonPIDMultiplicityPP"].Populate(NumberOfReconstructedProtonTracks)
			This.HistogramCollection1.Histograms["MultipleProtonECalMultiplicityPP"].Populate(NTrackerECalRecon)
	...
	def EventContainsElectronPositron(This, PIDParticles1, Protons, TruthInteractionType):
		...
		for Electron1 in Electrons:
			for Positron1 in Positrons:
				...
				This.HistogramCollection1.Histograms["ElectronPositronSeparationX"].Populate(math.fabs(Electron1.FrontPosition.X - Positron1.FrontPosition.X))
				This.HistogramCollection1.Histograms["ElectronPositronSeparationY"].Populate(math.fabs(Electron1.FrontPosition.Y - Positron1.FrontPosition.Y))
				This.HistogramCollection1.Histograms["ElectronPositronSeparationZ"].Populate(math.fabs(Electron1.FrontPosition.Z - Positron1.FrontPosition.Z))
