...
class Analysis:
	...
	def Analyse(self, n = 999999999):
		...
		self.ROOTFile1.NewHistogram1D("PhotonAngles", "Distribution of the angle between the Photon Direction and the start of the Proton Track Position", "Angle", "Number", 100, -90, 90, "")
		self.ROOTFile1.NewHistogram1D("ProtonPhotonTimeSeparations", "Time Separation between the Reconstructed Proton Track and Photon EC Cluster", "Time Separation", "Number", 100, 0, 4000, "")
		...
		if (self.InputTimeTest == False):
			...
			for Histogram1 in self.CutPurity.HistogramDictionary:
				for CutCounter in xrange(len(self.SelectionStatisticsList)):
					...
					self.ROOTFile1.Histogram1.GetXaxis().SetBinLabel(CutCounter+1, BinLabel)
