...
class Analysis:
	...
	def Analyse(self, DesiredEventNumber = 999999999):
		...
		self.ROOTFile1.NewHistogram1D("Single_Proton_PID_Electron_Pull", "Electron pull for all PIDs identified as proton-like", "Electron Pull", "Number", 100, -100, 100, "Proton/Recon/Particle Pulls/Single Proton/")
		self.ROOTFile1.NewHistogram1D("Single_Proton_PID_Kaon_Pull", "Kaon pull for all PIDs identified as proton-like", "Kaon Pull", "Number", 100, -100, 100, "Proton/Recon/Particle Pulls/Single Proton/")
		self.ROOTFile1.NewHistogram1D("Single_Proton_PID_Muon_Pull", "Muon pull for all PIDs identified as proton-like", "Muon Pull", "Number", 100, -100, 100, "Proton/Recon/Particle Pulls/Single Proton/")
		self.ROOTFile1.NewHistogram1D("Single_Proton_PID_Pion_Pull", "Pion pull for all PIDs identified as proton-like", "Pion Pull", "Number", 100, -100, 100, "Proton/Recon/Particle Pulls/Single Proton/")
		self.ROOTFile1.NewHistogram1D("Single_Proton_PID_Proton_Pull", "Proton pull for all PIDs identified as proton-like", "Proton Pull", "Number", 100, -100, 100, "Proton/Recon/Particle Pulls/Single Proton/")
	...
	def runEvent(self):
			...
			if (SuitableTPCNodeNumber):
				...
				if (len(PID.ParticleIds)>0):
					...
					for Particle , ParticlePull in PIDObject.ParticlePull.iteritems():
						if math.fabs(ParticlePull) < PullCutVariable:#This is currently buggy as multiple Pulls can satisfy this ... perhaps go for the particle with the lowest absolute pull?
		...
		for PIDObject1 in PIDObjectList:
			...
			if (PIDObject1.ReconParticleID == ParticleCodes.Proton):#Looking for reconstructed proton track
				...
				self.ROOTFile1.HistogramDictionary["Proton_PID_Electron_Pull"].Histogram.Fill(PIDObject.ParticlePull[ParticleCodes.Electron])
				self.ROOTFile1.HistogramDictionary["Proton_PID_Kaon_Pull"].Histogram.Fill(PIDObject.ParticlePull[ParticleCodes.Kaon1])
				self.ROOTFile1.HistogramDictionary["Proton_PID_Muon_Pull"].Histogram.Fill(PIDObject.ParticlePull[ParticleCodes.MuLepton])
				self.ROOTFile1.HistogramDictionary["Proton_PID_Pion_Pull"].Histogram.Fill(PIDObject.ParticlePull[ParticleCodes.Pi1Meson])
				self.ROOTFile1.HistogramDictionary["Proton_PID_Proton_Pull"].Histogram.Fill(PIDObject.ParticlePull[ParticleCodes.Proton])
