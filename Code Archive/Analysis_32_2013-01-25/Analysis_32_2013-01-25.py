...
class Analysis:
	...
	def Analyse(self, DesiredEventNumber = 999999999):
		...
		self.ReconProtonTrueEnergy=StackedHistogram.StackedHistogram("Recon_Proton_True_Energy", "True energy of particles reconstructed as protons", 0.7, 0.65, 0.86, 0.88, "Energy (GeV)", "Number",  "Proton/Truth/Energy")
		
		self.ReconProtonReconMomentum=StackedHistogram.StackedHistogram("Recon_Proton_Recon_Momentum", "Reconstructed momentum of particles reconstructed as protons", 0.7, 0.65, 0.86, 0.88, "Momentum (GeV)", "Number", "Proton/Recon/Momentum")
		...
		self.FinalInvariantMass=StackedHistogram.StackedHistogram("Final_Invariant_Mass", "Invariant Mass of Delta Baryon after all cuts have been applied", 0.7, 0.65, 0.86, 0.88, "Mass (GeV)", "Number", "Cuts/Invariant Mass/")
		self.InvariantMassAllECal=StackedHistogram.StackedHistogram("Invariant_Mass_All_ECal", "Invariant Mass of Delta Baryon from comparison of single photon to all ECals", 0.7, 0.65, 0.86, 0.88, "Mass (GeV)", "Number", "Cuts/Invariant Mass/All ECal/")
		...
		if (self.InputTimeTest == False):
			...
			self.NormalisedPurity=StackedHistogram.StackedHistogram("Normalised_Purity", "Constituent processes after each cut (Normalised)", 0.7, 0.65, 0.86, 0.88, "Cuts", "Events Remaining", "Cuts/Normalised/")

			#self.InvariantMassAllECal.ConstituentFill(ProcessSeparator.ProcessDictionary, EventProcess, DeltaBaryon.InvariantModulus(), "Invariant Mass for constituent", "Mass (GeV)", "Number", 100, 0, 3000, "InvariantMassAllECal")
			...
			for CriteriaListCounter in xrange(CutNumber):
				...
				if(self.SelectionStatisticsList[CriteriaListCounter].Purity > 0):
					...
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Delta -> p gamma interactions", "NormalisedPurity:DeltaPGamma", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].Purity, "Delta -> p gamma Interactions")
				
				if(self.SelectionStatisticsList[CriteriaListCounter].PionPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Delta -> p pi interactions", "NormalisedPurity:DeltaPPi", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].PionPurity, "Delta -> p pi Interactions")
			
				if(self.SelectionStatisticsList[CriteriaListCounter].RPPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Other Resonance Production", "NormalisedPurity:OtherResonance", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].RPPurity, "Other Resonance Production")
					
				if(self.SelectionStatisticsList[CriteriaListCounter].QSPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Quasi-Elastic Scattering", "NormalisedPurity:QES", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].QSPurity, "Quasi-Elastic Scattering")
				
				if(self.SelectionStatisticsList[CriteriaListCounter].ESPurity > 0):
										
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Elastic Scattering", "NormalisedPurity:ES", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].ESPurity, "Elastic Scattering")
			
				if(self.SelectionStatisticsList[CriteriaListCounter].DISPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Deep Inelastic Scattering", "NormalisedPurity:DIS", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].DISPurity, "Deep Inelastic Scattering")
					
				if(self.SelectionStatisticsList[CriteriaListCounter].CSPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Coherent Scattering", "NormalisedPurity:C", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].CSPurity, "Coherent Scattering")
										
				if(self.SelectionStatisticsList[CriteriaListCounter].OtherPurity > 0):
					
					self.NormalisedPurity.AttemptToFill2D(NormalisedPurityTitle, "Other Interactions", "NormalisedPurity:Other", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Normalised/Constituent Histograms/", CriteriaListCounter, self.SelectionStatisticsList[CriteriaListCounter].OtherPurity, "Other Interactions")
			...
			self.ROOTFile1.NewStackedHistogramCanvas("Normalised_Purity_Canvas", *self.NormalisedPurity.StackedHistogramCanvas("Normalised_Purity_Canvas", "Canvas of Normalised Cut Purity", 700, 500))
						
			self.NormalisedPurity.DrawConstituentHistograms(self.ROOTFile1)
	
			############## Application of truth to criteria
				
			self.CutPurity=StackedHistogram.StackedHistogram("Cut_Purity", "Constituent Processes for the Events after every Selection",0.7,0.65,0.86,0.88, "Cuts", "Events Remaining", "Cuts/Energy/")

			for CutCounter in xrange(len(self.SelectionStatisticsList)):
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].TruthDelta):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Delta -> p gamma interactions", "Purity:DeltaPGamma", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Delta -> p gamma Interactions")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].ReconstructedDelta):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Delta -> p pi interactions", "Purity:DeltaPPi", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Delta -> p pi Interactions")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].OtherRPInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Other Resonance Production", "Purity:OtherResonance", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Other Resonance Production")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].QSInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Quasi-Elastic Scattering", "Purity:QES", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Quasi-Elastic Scattering")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].ESInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Elastic Scattering", "Purity:ES", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Elastic Scattering")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].DISInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Deep Inelastic Scattering", "Purity:DIS", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Deep Inelastic Scattering")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].CSInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Coherent Scattering", "Purity:C", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Coherent Scattering")
				for FillCounter in xrange(self.SelectionStatisticsList[CutCounter].OtherInteraction):
					self.CutPurity.AttemptToFill1D(NormalisedPurityTitle, "Other Interactions", "Purity:Other", "Selections", "Purity", CutNumber, 0, CutNumber, "Cuts/Energy/Constituent Histograms/", CutCounter, "Other Interactions")
			...
			self.ROOTFile1.NewStackedHistogramCanvas("Final_Invariant_Mass", *self.FinalInvariantMass.StackedHistogramCanvas("Final_Invariant_Mass", "Canvas of the invariant mass of the delta baryon after all cuts have been applied", 700, 500))
		
			self.FinalInvariantMass.DrawConstituentHistograms(self.ROOTFile1)
			
			self.InvariantMassAllECal.AutoPrepare("f")
		
			self.ROOTFile1.NewStackedHistogramCanvas("Invariant_Mass_All_ECal", *self.InvariantMassAllECal.StackedHistogramCanvas("Invariant_Mass_All_ECal", "Canvas of the invariant mass of the delta baryon from comparison of single photon to all ECals", 700, 500))
	...
	def runEvent(self):
		...
		for PIDObject1 in PIDObjectList:
			...
			if (PIDObject1.ReconParticleID == ParticleCodes.Proton):
				...
				self.ReconProtonTrueEnergy.ConstituentFill1D(ParticleCodes.ParticleDictionary, PIDObject1.TrueParticleID, PIDObject1.TrueEnergy,"The Proton-Like Track reconstructed front momentum contribution from a true", "Energy (GeV)", "Number", 100, 0, 5000, "ProtonLikeTrueEnergy")
				self.ReconProtonReconMomentum.ConstituentFill1D(ParticleCodes.ParticleDictionary, PIDObject1.TrueParticleID, PIDObject1.ReconFrontMomentum,"The Proton-Like Track true energy contribution from a true", "Momentum (GeV)", "Number", 100, 0, 3000, "ProtonLikeReconFrontMomentum")
		...
		if (Criteria[len(Criteria) - 1] == True):
			...
			self.FinalInvariantMass.ConstituentFill1D(ProcessSeparator.ProcessDictionary, EventProcess, DeltaBaryon.InvariantModulus(), "Invariant Mass after all cuts for constituent", "Mass (GeV)", "Number", 100, 0, 3000, "FinalInvariantMass")
		...
		if (Criteria[7]):#Matching Single proton to Every ECal cluster
			...
			for Photon1 in PhotonList:
				...
				self.InvariantMassAllECal.ConstituentFill1D(ProcessSeparator.ProcessDictionary, EventProcess, DeltaBaryon.InvariantModulus(), "Invariant Mass for constituent", "Mass (GeV)", "Number", 100, 0, 3000, "InvariantMassAllECal")
