...
def WithinLocality(Point1, Point2, LocalityLimit):
	...
	if ((math.fabs(Point1.X - Point2.X) < LocalityLimit.X) and (math.fabs(Point1.Y - Point2.Y) < LocalityLimit.Y) and (math.fabs(Point1.Z - Point2.Z) < LocalityLimit.Z)):
		WithinLocality = True
...
class FourVector:
	...
	def InvariantModulus(This):
		...
		IMSquared = This.T * This.T - This.X * This.X - This.Y * This.Y - This.Z * This.Z
