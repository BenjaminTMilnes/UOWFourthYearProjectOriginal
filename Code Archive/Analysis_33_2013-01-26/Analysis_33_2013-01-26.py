...
class Analysis:
	...
	def Analyse(self, DesiredEventNumber = 999999999):
		...
		"""self.StackedHistograms["ReconProtonTrueEnergy"].AutoPrepare("f")
		
		self.ROOTFile1.NewStackedHistogramCanvas("Recon_Proton_True_Energy", *self.StackedHistograms["ReconProtonTrueEnergy"].StackedHistogramCanvas("Recon_Proton_True_Energy", "Canvas of true energies of reconstructed proton-like tracks", 700, 500))
		
		self.StackedHistograms["ReconProtonTrueEnergy"].DrawConstituentHistograms(self.ROOTFile1)"""
		
		
		"""self.StackedHistograms["ReconProtonReconMomentum"].AutoPrepare("f")
		
		self.ROOTFile1.NewStackedHistogramCanvas("Recon_Proton_Recon_Momentum", *self.StackedHistograms["ReconProtonReconMomentum"].StackedHistogramCanvas("Recon_Proton_Recon_Momentum", "Canvas of reconstructed momenta of reconstructed proton-like tracks", 700, 500))
		
		self.StackedHistograms["ReconProtonReconMomentum"].DrawConstituentHistograms(self.ROOTFile1)"""
