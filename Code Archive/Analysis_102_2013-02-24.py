...
class Analysis:
	...
	def Analyse(This, DesiredEventNumber = 999999999):
		...
		for i in range(EventNumber):
			...
			try:
				...
				print "Warning: An unidentified error occured at event number" , i
				print "The following error occured:" , traceback.format_exc()
	...
	def InitialiseHistograms(This):
		...
		This.HistogramCollection1.NewStackedHistogram1D("ElectronsAndAntielectrons_CorrectlyReconstruced_Process", "Photons/ElectronsAndAntielectrons/", "Constituent processes of true electrons and positrons that are not pair produced", "", 1, 0, 1, "Number")
	...
	def runEvent(This):
		...
		DeltaPGammaCriteria = [True, False, False, False, False, False, False, False, False, False]
	...
	def IsValidSpill(This):
		...
		if (This.MonteCarloData == True):
			...
			if (This.BasicDataQuality.ND280OffFlag == 1 and This.BeamSummaryData.BeamSummaryDataStatus == 0):#!! These numbers are counterintuitive
				ValidSpill = True
				
				for BeamSummaryData in This.BeamSummaryData.BeamSummaryData:
					
					if (BeamSummaryData.GoodSpillFlag != 1):
	...
	def ProtonsOnTargetData(This):
		...
		for BeamSummaryData in This.BeamSummaryData.BeamSummaryData:
			...
			ProtonsOnTargetData = BeamSummaryData.CT5ProtonsPerSpill
