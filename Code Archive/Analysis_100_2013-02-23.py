	...
	def runEvent(This):
		...
		for ReconstructedObject1 in ReconstructedObjects1:
			...
			if (ReconstructedObject1.ReconParticleID == ParticleCodes.Proton):#Looking for reconstructed proton track
				...
				This.HistogramCollection1.Histograms["Recon_Proton_Invariant_Mass"].Populate(ReconstructedObject1.FrontEnergyMomentum.InvariantModulus())
			
				if (This.MonteCarloData):
					This.HistogramCollection1.Histograms["Recon_Proton_Invariant_Mass_Stacked"].Populate(ReconstructedObject1.TrueParticleID, ReconstructedObject1.FrontEnergyMomentum.InvariantModulus(), ParticleCodes.ParticleName(ReconstructedObject1.TrueParticleID))
