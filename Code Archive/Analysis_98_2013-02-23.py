...
class Analysis:
	...
	def InitialiseHistograms(This):
		...
		This.HistogramCollection1.NewStackedHistogram1D("Recon_Proton_Invariant_Mass_Stacked", "Proton/Reconstruction/Invariant Mass/", "Invariant Mass of Reconstructed Protons", "Mass (GeV)", 100, 0, 2000, "Number")
		This.HistogramCollection1.NewHistogram1D("Recon_Proton_Invariant_Mass", "Proton/Reconstruction/Invariant Mass/", "Invariant Mass of Reconstructed Protons", "Mass (GeV)", 100, 0, 2000, "Number")
