				...
				if ((OutputData or (i == EventNumber - 1)) and (SuitableEvents > 0)):
					...
					for key in This.StackedHistograms.keys():
						...
						for key2 in This.StackedHistograms[key].HistogramDictionary.keys():
							...
							print This.StackedHistograms[key].HistogramDictionary[key2].Histogram
					...
					#for Key, StackedHist in This.StackedHistograms.iteritems():
					#	if (Key == "Pi0MesonMass"):
					#		for SubHist in StackedHist.HistogramDictionary.itervalues():
					#			print SubHist.Histogram
