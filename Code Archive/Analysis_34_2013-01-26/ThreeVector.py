...
def FindAngle(Vector1, Vector2):
	...
	Theta1 = math.asin((ScalarProduct(Vector1, Vector2)) / (Vector1.Modulus() * Vector2.Modulus())) * 360 / (2 * math.pi)#I have changed this back to asin, it is easier to work with later on
