...
class Analysis:
	...
	def runEvent(This):
		...
		if (NumberOfReconstructedProtonTracks <= This.Parameters["ProtonTrackMultiplicityLimitECalChannel"] and DeltaPGammaCriteria[11]):
			DeltaPGammaCriteria[12] = True
			
		if (NTrackerECalRecon <= This.Parameters["ECalMultiplicityLimitECalChannel"] and DeltaPGammaCriteria[12]):
