...
class Analysis:
	...
	def InitialiseHistograms(This):
		...
		This.ROOTFile1.NewHistogram1D("MultipleProtonPIDMultiplicityECal", "PID multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", "Number", 10, 0, 10, "Proton/Recon/Multiplicity/")
		This.ROOTFile1.NewHistogram1D("MultipleProtonECalMultiplicityECal", "ECal multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", "Number", 10, 0, 10, "Photon/Recon/Multiplicity/")
		
		This.ROOTFile1.NewHistogram1D("MultipleProtonPIDMultiplicityPP", "PID multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", "Number", 10, 0, 10, "Proton/Recon/Multiplicity/")
		This.ROOTFile1.NewHistogram1D("MultipleProtonECalMultiplicityPP", "ECal multiplicity for events that have a proton and photon within angle and synchronicity", "Multiplicity", "Number", 10, 0, 10, "Photon/Recon/Multiplicity/")
		
		This.ROOTFile1.NewHistogram1D("ElectronPositronSeparationX", "Electron positron separation in X axis", "Separation (mm)", "Number", 100, 0, This.Parameters["LocalityLimit"] * 10, "Photon/")
		This.ROOTFile1.NewHistogram1D("ElectronPositronSeparationY", "Electron positron separation in Y axis", "Separation (mm)", "Number", 100, 0, This.Parameters["LocalityLimit"] * 10, "Photon/")
		This.ROOTFile1.NewHistogram1D("ElectronPositronSeparationZ", "Electron positron separation in Z axis", "Separation (mm)", "Number", 100, 0, This.Parameters["LocalityLimit"] * 10, "Photon/")
	...
	def runEvent(This):
		...
		if (DeltaPGammaCriteria[6]):
			...
			This.ROOTFile1.HistogramDictionary["MultipleProtonPIDMultiplicityECal"].Histogram.Fill(NumberOfReconstructedProtonTracks)
			This.ROOTFile1.HistogramDictionary["MultipleProtonECalMultiplicityECal"].Histogram.Fill(NTrackerECalRecon)
			
		if (ProtonPhotonToElectrons[6]):
			This.ROOTFile1.HistogramDictionary["MultipleProtonPIDMultiplicityPP"].Histogram.Fill(NumberOfReconstructedProtonTracks)
			This.ROOTFile1.HistogramDictionary["MultipleProtonECalMultiplicityPP"].Histogram.Fill(NTrackerECalRecon)
	...
	def EventContainsElectronPositron(This, PIDParticles1, Protons, TruthInteractionType):
		...
		for Electron1 in Electrons:
			for Positron1 in Positrons:
				...
				This.ROOTFile1.HistogramDictionary["ElectronPositronSeparationX"].Histogram.Fill(math.fabs(Electron1.FrontPosition.X - Positron1.FrontPosition.X))
				This.ROOTFile1.HistogramDictionary["ElectronPositronSeparationY"].Histogram.Fill(math.fabs(Electron1.FrontPosition.Y - Positron1.FrontPosition.Y))
				This.ROOTFile1.HistogramDictionary["ElectronPositronSeparationZ"].Histogram.Fill(math.fabs(Electron1.FrontPosition.Z - Positron1.FrontPosition.Z))
